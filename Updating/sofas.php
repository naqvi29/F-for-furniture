...
<section class="bedstore_products">
    <div class="container-xxl">
        <div class="row g-4">
            ...
            $total_pages_sql = "SELECT COUNT(*) FROM products WHERE p_cat = 3;";
            $result = mysqli_query($conn, $total_pages_sql);
            $total_rows = mysqli_fetch_array($result)[0];
            $total_pages = ceil($total_rows / $no_of_records_per_page);

            $sql = "SELECT * FROM products WHERE p_cat = 3 LIMIT $offset, $no_of_records_per_page";
        ...
        <?php
        $query = "SELECT * FROM products WHERE p_cat = 3";
