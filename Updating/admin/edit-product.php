            ...
            <div class="navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0 me-4 order-lg-1" href="index.html"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="index.html"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
                    ...
                    <div class="navbar-toolbar d-flex align-items-center order-lg-3">
                        ...
                        </a><a class="navbar-tool d-none d-lg-flex" href="dashboard-favorites.html"><span class="navbar-tool-tooltip">Favorites</span>
                        ...
                        <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                if ($imgformat) {
                                    ...
                                    $update_query = "UPDATE products SET `p_name` = '$p_name', `p_brand` = '$p_brand', `p_price` = '$p_price',
                                    `p_desc` = '$p_desc', `p_image` = '$p_image', `p_tags` = '$p_tags', `p_cat` = '$p_cat', `p_color` = '$p_color',
                                    `status` = '$status', `p_size` = '$p_size', `p_seats` = '$p_seats' WHERE `p_id` = '$id';";
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6 mb-3 pb-2">
                                        ...
                                        <input class="form-control" type="text" name="p_name" id="p_name" value="<?php echo $fetch[1]?>">
                                    </div>
                                    <div class="col-sm-6 mb-3 pb-2">
                                ...
                                <div class="file-drop-area mb-3">
                                    ...
                                    <input class="file-drop-input" type="file" name="p_image" id="p_image" value="<?php echo $fetch[5]; ?>">
                                ...
                                <div class="mb-3 py-2">
                                    ...
                                    <textarea class="form-control" name="p_desc" id="p_desc" rows="6"><?php echo $fetch[4]; ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="input-group"><span class="input-group-text"><i class="fa-solid fa-euro-sign"></i></span>
                                            <input class="form-control" type="text" name="p_price" id="p_price" value="<?php echo $fetch['3'];?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <select name="p_cat" class="form-select" id="p_cat" value="<?php echo $row[8]?>">
                                                <option value="">Select</option>
                                                <?php
                                ...
                                <div class="mb-3 py-2">
                                    ...
                                    <textarea class="form-control" rows="4" name="p_tags" id="p_tags"><?php echo $fetch['6']; ?></textarea>
                                ...
                                <button class="btn btn-primary d-block w-100" type="submit" name="update"><i class="fa-solid fa-arrow-up-from-bracket fs-lg me-2"></i>Upload Product</button>
                            </form>
                        </div>
                    </section>
                </div>
