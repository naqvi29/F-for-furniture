            ...
            <div class="bg-light shadow-lg rounded-3 overflow-hidden">
                <div class="row">
                    ...
                    if (isset($_POST['update'])) {
                        ...
                        $update = "UPDATE `users` SET `user_name` = '$username', `user_email` = '$useremail', `user_password` = '$userpassword' WHERE `users`.`user_id` = '$user_id';";
                        $result = mysqli_query($conn, $update);
                        echo "<script>alert('updated'); window.history.go(-2);</script>";
                    }
                    ?>
                    <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
                        <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                            ...
                            <div class="d-sm-flex flex-wrap justify-content-between align-items-center pb-2">
                                <h2 class="h3 py-2 me-2 text-center text-sm-start">Edit Registered Users</h2>
                            </div>
                            <form action="" method="post">
                                <div class="row gx-4 gy-3">
                                    <div class="col-sm-6">
                                        <label class="form-label" for="username">User Name</label>
                                        <input type="text" class="form-control" name="user-name" id="" value="<?php echo $row[1]; ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="username">User Email</label>
                                        <input type="email" class="form-control" name="user-email" id="" value="<?php echo $row[2]; ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="username">User Password</label>
                                        <input type="password" class="form-control" onkeydown="return false;" name="user-pass" id="" value="<?php echo $row[3]; ?>">
                                    </div>
                                    <div class="col-12">
                                        <hr class="mt-2 mb-4">
                                        <div class="d-sm-flex justify-content-center align-items-center">
                                            <button class="btn btn-primary mt-3 mt-sm-0" name="update" type="submit">Save Changes</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
